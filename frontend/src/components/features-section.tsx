...
const features = [
  {
    ...
    description:
      "Advanced AI algorithms analyze crowd density, movement patterns, and behavior in real-time to provide actionable insights.",
  },
  {
    icon: AlertTriangle,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
            Cutting-edge AI technology designed to revolutionize crowd management and enhance public safety across all
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <Card key={index} className="glass border-border/50 hover:bg-card/80 transition-all duration-300 group">
