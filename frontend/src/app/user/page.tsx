...
export default async function UserPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden pb-10">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_15%_15%,rgba(59,130,246,0.28),transparent_38%),radial-gradient(circle_at_85%_0%,rgba(168,85,247,0.22),transparent_40%),radial-gradient(circle_at_50%_100%,rgba(16,185,129,0.2),transparent_42%)] transition-opacity duration-300" />
